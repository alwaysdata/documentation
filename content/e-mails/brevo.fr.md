...
linkTitle = "Utiliser Brevo"
tags = ["email"]
+++

Brevo (anciennement Sendinblue) est une plateforme d'emailing connue. Pour améliorer la délivrabilité des emails envoyés, il faut les [authentifier](/e-mails/set-up-spf-dkim-dmarc) en créant, chez votre prestataire, des enregistrements DNS qu'ils vous donneront. Voici comment le faire chez alwaysdata.
