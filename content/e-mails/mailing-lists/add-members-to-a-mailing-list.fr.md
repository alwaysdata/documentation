+++
url = "/fr/emails/listes-de-diffusion/ajouter-des-membres-a-une-liste-de-diffusion/"
title = "Ajouter des membres à une liste de diffusion"
tags = ["email", "mailing list"]
+++

Pour ajouter des membres à une liste de diffusion, vous devez vous connecter à l'[interface de gestion Postorius](https://mailman.alwaysdata.com/). Connectez-vous à l'aide d'une adresse mail d'administration que vous aurez défini à la [création de votre liste de diffusion](/e-mails/mailing-lists/create-a-mailing-list).
