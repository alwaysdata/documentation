...
- the [provisioned versions](languages/ruby/configuration#supported-versions) range from 1.8 to 3.4,
- the [environment configuration](languages/ruby/configuration#environment) is easy to set up.
