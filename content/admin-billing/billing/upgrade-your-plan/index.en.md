...
You can change the *[pack](/admin-billing/billing/public-cloud-prices)* and the *commitment period*. The invoice for the new subscription is generated the next day and you will have 30 days to pay it.


In the following cases, contact [support](https://admin.alwaysdata.com/support/add/):

- Take a [Private Cloud](/admin-billing/billing/private-cloud-prices) (or change its configuration / commitment period),
