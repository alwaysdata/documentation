+++
url = "/fr/admin-facturation/facturation/changer-doffre/"
...
Vous pouvez changer de _[pack](/admin-billing/billing/public-cloud-prices)_ et de _période d'engagement_. La facture pour le nouvel abonnement est éditée le lendemain et vous aurez alors 30 jours pour la payer.

Dans les cas suivant, il faudra contacter le [support](https://admin.alwaysdata.com/support/add/) :

- prendre un [Cloud Privé](/admin-billing/billing/private-cloud-prices) (ou en changer sa configuration / la période d'engagement) ;
