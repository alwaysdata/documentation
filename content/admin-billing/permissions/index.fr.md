+++
url = "/fr/admin-facturation/permissions/"
title = "Permissions"
...
- __Technique au niveau des serveurs__ : disponible sur [Cloud Privé](/admin-billing/billing/private-cloud-prices), votre administrateur réseau pourra gérer règles de firewall, queue d'envoi des emails et bien d'autres...
...
- __Ressources__ : permission pour les comptes sur [Cloud privé](/admin-billing/billing/private-cloud-prices) permet de gérer les [sondes](/web-hosting/sites/use-probes) (menu *Web > Sondes*) et [ressources](/technical-specifications/system-resources-alerts-and-limitations) (menu *Avancé > Ressources*) ;
...
- __[Migration](/technical-specifications/migrations)__ (menu *Avancé > Migrations*) ;
...
- __[Règles firewall](/technical-specifications/configure-firewall)__ : créez des règles firewall et consultez le bannissement automatique d'IP au niveau du serveur  (menu *Firewall*);
...
- __[Ressources](/technical-specifications/system-resources-alerts-and-limitations)__ : modifiez les limitations de ressources par compte - RAM, CPU, espace disque (menu *Ressources*).
- __[Migration](/technical-specifications/migrations)__ (menu *Migrations*) ;

## 2FA nécessaire

Lorsque la case **2FA nécessaire** est cochée, l'utilisateur en question doit se connecter [avec 2 facteurs](/admin-billing/profile/two-factor-authentication) pour accéder aux menus auxquels on lui a donné accès.
