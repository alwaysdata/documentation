...
- Non-standard extensions (APC, Xapian, Xdebug and Mapscript for PHP 5.3 and 5.2 and Fileinfo in 5.2) are deleted. You can however [install them yourself](/web-hosting/languages/php/extensions) in your own account.

- Symfony is no longer pre-installed, you need to [install manually](/web-hosting/languages/php/packages).
...
- The few libraries that were previously ready installed by default are now deleted, including Django. You will therefore need to [manually install](/web-hosting/languages/python/configuration#environment) all of the libraries that you will need.
...
- The few libraries that were previously ready installed by default are now deleted, including Ruby on Rails. You will therefore need to [manually install](/web-hosting/languages/ruby/configuration#environment) all of the libraries that you will need.
