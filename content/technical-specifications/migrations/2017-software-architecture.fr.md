+++
url = "/fr/caracteristiques-techniques/migrations/architecture-logicielle-2017/"
...
* Les extensions non standard (APC, Xapian, Xdebug et Mapscript pour PHP 5.3 et 5.2 et Fileinfo en 5.2) sont supprimées. Vous pourrez toutefois les [installer vous-même](/web-hosting/languages/php/extensions) dans votre propre compte.

* Symfony n'est plus préinstallé, vous devrez [manuellement l'installer](/web-hosting/languages/php/packages).
...
* Les quelques bibliothèques auparavant préinstallées par défaut sont supprimées, y compris Django. Vous devez donc [manuellement installer](/web-hosting/languages/python/configuration#environnement) toutes les bibliothèques dont vous aurez besoin.
...
* Les quelques bibliothèques auparavant préinstallées par défaut sont supprimées, y compris Ruby on Rails. Vous devez donc [manuellement installer](/web-hosting/languages/ruby/configuration#environnement) toutes les bibliothèques dont vous aurez besoin.
