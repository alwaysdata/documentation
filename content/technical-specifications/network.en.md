...
Users who own [Private Clouds](/admin-billing/billing/private-cloud-prices) can [configure their firewall](/technical-specifications/configure-firewall) directly from their administration interface, via the server's **Firewall** menu.
