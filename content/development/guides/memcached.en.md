...
{{% notice info %}}
For Private Cloud users *Memcached* can be [installed at server level](/web-hosting/databases/memcached).
{{% /notice %}}
...
- [Install the PHP extension](/web-hosting/databases/memcached/php)
