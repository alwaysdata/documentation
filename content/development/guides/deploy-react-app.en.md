...
Just create a [Static files](/web-hosting/sites/static-files) site pointing to the directory of your choice (e.g.
`www/my-app`).
...
created the site, for example by using [_rsync/SSH_](/web-hosting/remote-access/ssh) :
