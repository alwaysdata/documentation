+++
url = "/fr/developpement/guides/couchdb/"
title = "CouchDB"
...
Les utilisateurs du [Cloud public](/admin-billing//billing/public-cloud-prices) devront faire pointer le service sur un port entre 8300 à 8499 et modifier cette valeur dans le fichier de configuration.
...
Les utilisateurs du [Cloud Privé](/admin-billing/billing/private-cloud-prices) devront ouvrir le port utilisé en créant une règle sur le [parefeu](/technical-specifications/configure-firewall) s'ils souhaitent y accéder depuis l'extérieur :
