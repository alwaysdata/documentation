+++
title = "Blocking visits using GeoIP"
tags = ["security", "site"]
+++

[MaxMind DB](https://www.maxmind.com/en/geoip2-services-and-databases)[^1] is an [Apache](/web-hosting/sites/configure-apache) module of GeoIP that aims to locate a user based on their IP address.

## Installation

Run the following commands in [SSH](/web-hosting/remote-access/ssh) at the root of the account:
