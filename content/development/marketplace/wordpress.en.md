...
- [Activate HTTP cache on WordPress](/web-hosting/sites/activate-http-cache-on-wordpress)
...
- implement the [specific profile](/web-hosting/sites/waf#available-profiles) of our WAF,
...
- [other rules](/web-hosting/sites/clean-up-a-site#3-delete-infection-sources).
