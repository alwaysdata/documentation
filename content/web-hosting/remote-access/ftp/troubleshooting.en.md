...
An [IP blockage](/technical-specifications/network) occurs after some ten failed attempts to connect to the server.
...
If none of these solutions works, try the [SFTP](/web-hosting/remote-access/sftp) connection.
...
If you can not change this behavior, try the [SFTP](/web-hosting/remote-access/sftp) connection.
