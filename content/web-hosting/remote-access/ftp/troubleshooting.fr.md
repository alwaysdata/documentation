+++
url = "/fr/hebergement-web/acces-distant/ftp/problemes-frequents/"
...
Un [blocage d'IP](/technical-specifications/network) a lieu après une dizaine de tentatives échouées de connexion au serveur.
...
Si aucune de ces solutions ne fonctionne, essayez la connexion [SFTP](/web-hosting/remote-access/sftp).
...
Si vous ne pouvez corriger ce comportement, vous pouvez essayez la connexion [SFTP](/web-hosting/remote-access/sftp).
