...
Users of the [Private Cloud](/admin-billing/billing/choose-its-paas) can state them [directly in the administration interface](/web-hosting/remote-access/ssh/install-globally-ssh-keys), they will be global to the entire server and all accounts can use them.
