+++
url = "/fr/hebergement-web/acces-distant/ssh/creer-un-utilisateur-ssh/"
...
- Mot de passe : mot de passe associé à l'utilisateur. Il est nécessaire pour la première connexion SSH ; la [connexion par clés](/web-hosting/remote-access/ssh/use-keys) peut ensuite être utilisée ;
