+++
url = "/fr/hebergement-web/acces-distant/ssh/utiliser-des-cles-ssh/"
...
Les utilisateurs du [Cloud Privé](/admin-billing/billing/choose-its-paas) peuvent les déclarer [directement dans l'interface d'administration](/web-hosting/remote-access/ssh/install-globally-ssh-keys), elles seront alors globales au serveur et donc utilisables par tous les comptes.
