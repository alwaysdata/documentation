...
- use our [backup recovery](/web-hosting/backups/restore-a-site) feature,
...
In Public Cloud, the maximum number of simultaneous connections per user is *50*. On request, it is possible to change this for [Private Cloud](/admin-billing/billing/private-cloud-prices).
