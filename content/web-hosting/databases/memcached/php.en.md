...
Using Memcached in PHP requires [installing a PECL extension](/web-hosting/languages/php/extensions#from-peclhttpspeclphpnet) in your account through [SSH](/web-hosting/remote-access/ssh).
