+++
url = "/fr/hebergement-web/bases-de-donnees/postgresql/"
title = "PostgreSQL"
...
- utiliser notre fonctionnalité de [restauration de sauvegarde](/web-hosting/backups/restore-a-site) ;
...
En Cloud Public, le nombre de connexions simultanées maximum par utilisateur est de _50_. Il est possible à la demande de le modifier en [Cloud Privé](/admin-billing/billing/private-cloud-prices).
