...
{{< fig "images/admin-panel_create-task_type.en.png" "" >}}

- the SSH environment

{{< fig "images/admin-panel_create-task_environment.en.png" "" >}}

- the task frequency: you can specify a fixed time or an interval

{{< fig "images/admin-panel_create-task_frequency.en.png" "" >}}
...
{{% notice note %}}
If your script needs to allow some IPs, allow these [IP adresses ranges](/technical-specifications/ip-ranges).
{{% /notice %}}

[Public Cloud](/admin-billing/billing/public-cloud-prices) users:

- The consumption should remain reasonable. If the scheduled task is major processing, then reduce its frequency.

[Private Cloud](/admin-billing/billing/private-cloud-prices) users:
