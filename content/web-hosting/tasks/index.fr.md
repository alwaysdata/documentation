+++
url = "/fr/hebergement-web/taches-planifiees/"
...
{{< fig "images/admin-panel_create-task_type.fr.png" "" >}}

- l'environnement SSH

{{< fig "images/admin-panel_create-task_environment.fr.png" "" >}}

- la pério­di­ci­té de votre tâche : vous pou­vez spé­ci­fiez une heure fixe, ou un inter­valle

{{< fig "images/admin-panel_create-task_frequency.fr.png" "" >}}
...
Utilisateurs du [Cloud Public](/admin-billing/billing/public-cloud-prices) :
...
Utilisateurs du [Cloud Privé](/admin-billing/billing/private-cloud-prices) :
