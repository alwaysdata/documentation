...
- the [provisioned versions](/web-hosting/languages/python/configuration#supported-versions) range from 2.4 to 3.14,
- the [environment configuration](/web-hosting/languages/python/configuration#environment) is easy to set up.
