...
- the [proposed versions](/web-hosting/languages/lua/configuration#supported-versions) range from 5.1 to 5.4,
- the [environment configuration](/web-hosting/languages/lua/configuration#environment) is easy to set up.
