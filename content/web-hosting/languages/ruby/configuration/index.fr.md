+++
url = "/fr/hebergement-web/langages/ruby/configuration/"
...
Vous pouvez utiliser un autre serveur web en le lançant en type [Programme utilisateur](/web-hosting/sites/user-program).
