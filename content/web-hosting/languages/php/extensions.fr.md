+++
url = "/fr/hebergement-web/langages/php/installer-une-extension/"
...
Les sections suivantes vous indiquent comment vous procurer de nouvelles extensions. Toutes les commandes sont à exécuter en [SSH](/web-hosting/remote-access/ssh).
