+++
url = "/fr/hebergement-web/langages/go/configuration/"
title = "Configurer Go"
tags = ["golang"]
+++
...
Pour déployer une application HTTP avec Go, créez un site de type *[Programme utilisateur](/web-hosting/sites/user-program)* dans la section **Web > Sites**.
