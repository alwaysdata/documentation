+++
url = "/fr/hebergement-web/langages/dotnet/"
title = ".NET"
+++
...
- Les [versions](/web-hosting/languages/dotnet/configuration#versions-supportées) 5.0, 6.0, 8.0 et 10.0 sont disponibles ;
- la [configuration d'environnement](/web-hosting/languages/dotnet/configuration#environnement) se fait simplement.
