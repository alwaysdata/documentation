+++
url = "/fr/hebergement-web/langages/nodejs/"
title = "Node.js"
tags = ["nodejs"]
+++
...
* les [versions proposées](/web-hosting/languages/nodejs/configuration#versions-supportées) vont de la 6 à la 24 ;
* la [configuration d'environnement](/web-hosting/languages/nodejs/configuration#environnement) se fait très simplement.
