...
- the [provisioned versions](/web-hosting/languages/nodejs/configuration#supported-versions) range from 6 to 24,
- the [environment configuration](/web-hosting/languages/nodejs/configuration#environment) is easy to set up.
