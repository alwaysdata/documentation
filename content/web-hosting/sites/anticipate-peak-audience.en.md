...
- Enable the **[HTTP cache](/web-hosting/sites/http-cache)** on your administration interface and/or at the application level using [Memcached](/development/guides/memcached), [Redis](/development/guides/redis) or any other software cache,
- Change to the latest possible language versions - to improve performance,
- Set a redirect to a **[static page](/web-hosting/sites/static-files)** - using far less resources, these can be sent faster.
