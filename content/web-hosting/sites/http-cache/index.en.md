...
{{< fig "images/admin-panel_add-site-cache.en.png" "" >}}
...
{{% notice note %}}
While the HTTP cache is appropriate in most cases, you can also [run Varnish](/web-hosting/sites/user-program) on your alwaysdata account.
{{% /notice %}}
