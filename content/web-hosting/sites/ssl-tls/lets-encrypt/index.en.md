...
To avoid duplicates, alwaysdata enables the generation of Let's Encrypt certificates only for [wildcard certificats](/web-hosting/sites/ssl-tls/lets-encrypt#certificates-wildcard).
