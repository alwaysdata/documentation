...
If you do not have an SSL certificate, you can use our [Let's Encrypt certificates](/web-hosting/sites/ssl-tls/lets-encrypt) or buy them from an SSL certificate vendor after providing them with the [previously created CSR](/web-hosting/sites/ssl-tls/csr).
