+++
url = "/fr/hebergement-web/sites/ssl-tls/priorite-de-renvoi-des-certificats-ssl/"
title = "Quel certificat SSL est renvoyé par défaut ?"
linkTitle = "Priorité des certificats"
tags = ["https", "ssl"]
+++
...
- Le [certificat auto-généré Let's Encrypt](/web-hosting/sites/ssl-tls/lets-encrypt#automatically-generated-certificates) correspondant au nom d'hôte.
