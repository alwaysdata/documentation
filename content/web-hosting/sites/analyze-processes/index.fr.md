+++
url = "/fr/hebergement-web/sites/analyser-des-processus/"
...
L'analyse des processus produit un fichier, disponible à la racine de votre compte (nommé `analysis_[date]-[heure].log` et consultable en [SSH](/web-hosting/remote-access/ssh) ou [FTP](/web-hosting/remote-access/ftp)) décrivant les opérations exécutées par le processus pendant une durée déterminée.
