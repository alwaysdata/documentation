+++
url = "/fr/hebergement-web/sites/anticiper-un-pic-daudience/"
...
- activer le **[cache HTTP](/web-hosting/sites/http-cache)** sur votre interface d'administration et/ou au niveau applicatif en utilisant [Memcached](/development/guides/memcached), [Redis](/development/guides/redis) ou tout autre cache logiciel ;
- passer sur les versions de langages les plus récentes possibles  - pour améliorer les performances ;
- faire une redirection vers une **[page statique](/web-hosting/sites/static-files)** - utilisant bien moins de ressources, elles sont plus rapides à renvoyer.
