+++
url = "/fr/hebergement-web/sites/programme-utilisateur/"
...
Il pourra être utilisé pour les langages [Erlang](https://www.erlang.org/), [Go](/web-hosting/languages/go), [Java](/web-hosting/languages/java), [Lua](/web-hosting/languages/lua), [Rust](/web-hosting/languages/rust), [Scala](https://www.scala-lang.org/), ou encore bien d'autres...[^1]
...
{{% notice tip %}}
Avant de mettre en place le site, vous pouvez tester le lancement du programme en [SSH](/web-hosting/remote-access/ssh).
{{% /notice %}}
