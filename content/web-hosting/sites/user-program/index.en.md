...
It may be used for [Erlang](https://www.erlang.org/), [Go](/web-hosting/languages/go), [Java](/web-hosting/languages/java), [Lua](/web-hosting/languages/lua), [Rust](/web-hosting/languages/rust), [Scala](https://www.scala-lang.org/),) and many other languages and software...[^1]
...
{{% notice tip %}}
Before setting up the site, you can test running the program in [SSH](/web-hosting/remote-access/ssh).
{{% /notice %}}
