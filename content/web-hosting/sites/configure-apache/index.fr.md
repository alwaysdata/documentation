+++
url = "/fr/hebergement-web/sites/configurer-apache/"
...
Une fois le fichier `.so` compilé et ajouté à votre [espace de fichiers](/web-hosting/remote-access), insérez cette ligne dans les directives globales :

```
LoadModule <MODULE> $HOME/chemin/vers/le/module.so
```

- [GeoIP](/development/guides/geoip)
