...
- [File .htaccess](/web-hosting/sites/htaccess-file)

## Installing a module

Once the `.so` file is compiled and added to your [file space](/web-hosting/remote-access), insert this line into the global directives:
