+++
url = "/fr/hebergement-web/sites/utiliser-des-adresses-externes/"
title = "Utiliser des adresses externes"
tags = ["dns", "http", "site"]
+++
...
2. sur l'interface d'administration alwaysdata, [déclarer les adresses](/web-hosting/sites/add-a-site) dans **Web > Sites**.
