...
{{% notice warning %}}
If you only wish to add global directives to Apache, change its [configuration](/web-hosting/sites/configure-apache) in **Web > Configuration > Apache**.
{{% /notice %}}
