+++
url = "/fr/hebergement-web/sites/apache-personnalise/"
title = "Utiliser le type Apache personnalisé"
linkTitle = "Apache personnalisé"
...
{{% notice warning %}}
Si vous voulez seulement ajouter des directives globales à Apache modifiez sa [configuration](/web-hosting/sites/configure-apache) dans **Web > Configuration > Apache**.
{{% /notice %}}
