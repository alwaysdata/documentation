+++
url = "/fr/hebergement-web/sites/desinfecter-un-site/"
...
Les commandes ci-après, présentées pour un site utilisant PHP, sont exécutées via [SSH](/web-hosting/remote-access/ssh) dans le répertoire de votre site.
...
{{% notice tip %}}
Si l'infection est **récente** et la recherche de l'infection compliquée, il est possible de repartir d'une [sauvegarde](/web-hosting/backups).
{{% /notice %}}
...
- Mettez en place le [pare-feu applicatif web](/web-hosting/sites/waf) ;
