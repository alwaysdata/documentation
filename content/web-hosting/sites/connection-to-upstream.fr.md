+++
url = "/fr/hebergement-web/sites/erreurs-connection-to-upstream/"
title = 'Corriger les erreurs "Connection to upstream refused/skipped"'
linkTitle = 'Problèmes "Upstream"'
...
Pour les sites ne passant pas par Apache ou uWSGI, vérifiez le lancement du programme en [SSH](/web-hosting/remote-access/ssh). Notamment s'il écoute bien :
