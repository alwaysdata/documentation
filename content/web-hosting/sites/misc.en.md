...
However, there is *no guarantee* that an application will never be stopped, and it can be stopped at any time. If it is *necessary* for a web application to run 24/7, create a [service](/web-hosting/services) and a site of type [Redirect "reverse-proxy"](/web-hosting/sites/redirect) for its web access.
