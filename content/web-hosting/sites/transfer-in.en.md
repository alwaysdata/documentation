...
linkTitle = "Transferring a Website"
tags = ["site"]
+++
...
1.  Retrieve the files and the database from the current provider,
    - Copy the files to your alwaysdata account using [FTP](/web-hosting/remote-access/ftp) or [SSH](/web-hosting/remote-access/ssh),
...
2.  [Setup the site](/web-hosting/sites/add-a-site) in **Web > Sites** with a preproduction address - e.g. the account address.
...
{{% notice tip %}}
For the commands you can follow the [Move a site](/web-hosting/sites/move-a-site) documentation instructions.
{{% /notice %}}
