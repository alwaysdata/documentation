+++
url = "/fr/hebergement-web/sites/fichier-htaccess/"
...
Cette fonctionnalité est disponible directement en déclarant un site de type [Redirection](/web-hosting/sites/redirect), mais vous pouvez le faire grâce au fichier `.htaccess` :
