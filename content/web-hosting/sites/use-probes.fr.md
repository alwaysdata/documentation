+++
url = "/fr/hebergement-web/sites/utiliser-les-sondes-de-monitoring/"
title = "Utiliser les sondes de monitoring"
linkTitle = "Sondes de monitoring"
tags = ["http", "site"]
+++

Pour nos utilisateurs qui disposent d'un [serveur Dédié/Gold](/admin-billing/billing/private-cloud-prices), il est possible de programmer des sondes de monitoring afin de vérifier qu'un site web fonctionne correctement. Si un problème est constaté par une sonde, une alerte est envoyée à notre équipe.
