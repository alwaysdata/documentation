+++
url = "/fr/hebergement-web/sauvegardes/"
title = "Sauvegardes"
weight = 60
...
Vous pouvez restaurer [un site web](/web-hosting/backups/restore-a-site) ou des [emails](/web-hosting/backups/restore-e-mails) dans l'onglet **Avancé > Restauration de sauvegardes** de votre interface d'administration.
...
- [Plan de continuité d'activité d'alwaysdata](/technical-specifications/drp)
