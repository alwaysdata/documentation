...
You can restore [a website](/web-hosting/backups/restore-a-site) or [e-mails](/web-hosting/backups/restore-e-mails) from the **Advanced > Restore backups** tab in your administration interface.
...
- [alwaysdata Disaster Recovery Plan](/technical-specifications/drp)
