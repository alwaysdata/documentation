...
Regarding the website, there are a number of possible choices:
  ...
  - adding the addresses before they point to our servers. In this case, there may be a delay relating to the generation of [SSL Let's Encrypt certificates](/web-hosting/sites/ssl-tls/lets-encrypt),
