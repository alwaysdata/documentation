...
This Sunday (Jan. 28th) is [Data Privacy Day](https://staysafeonline.org/data-privacy-day/). We at *alwaysdata* want to take this opportunity to tell you about why this topic is so important and our opinions about it.
...
Beginning in May, the GDPR (EU General Data Protection Regulation) will go into effect. This regulation intends to limit and legally frame the use of personal data. The producer of data is its legal owner. No one will be allowed to deprive you of your right to use and protect those data. Likewise, no one will be allowed to use your data to recommend services to you or to track you without your permission.
...
If you're interested in privacy, the [Nothing to Hide](https://vimeo.com/nothingtohide) documentary is a good resource for learning about these challenges.

## Protect your data easily with *alwaysdata*

With data portability, you are now able to get back your personal data and host them. *alwaysdata*'s hosting services are perfectly suited for this use case. Offering the most-used web languages, database technologies, and large storage even in a [shared hosting](https://www.alwaysdata.com/en/offers/plus/), *alwaysdata* makes sure that you're ready!
...
- [Nextcloud](https://nextcloud.com/) (PHP / MariaDB or MySQL): a solution to centralize and share documents. Nextcloud allows you to host documents, contacts, agenda, etc. in the same location, share them easily, and collaborate.
- [Cozy Cloud](https://cozy.io) (Go / CouchDB): a data hub that allows you to gather all your personal data, including documents, banking, and health data, etc. It embeds a way to connect to your online services, allowing you to gather and extract your data from them.
- [Seafile](https://www.seafile.com) (Python / SQLite): an online drive that syncs your documents between your devices and your server.
- [Syncthing](https://syncthing.net/) (Go): a sync solution with sharing features that allows you to access your data from anywhere.
