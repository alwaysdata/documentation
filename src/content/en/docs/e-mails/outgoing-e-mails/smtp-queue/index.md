...
- to delete e-mails from the waiting list (which would be problematic in the event of [sending spam](/en/docs/e-mails/outgoing-e-mails/react-to-spam-mailing/)).
