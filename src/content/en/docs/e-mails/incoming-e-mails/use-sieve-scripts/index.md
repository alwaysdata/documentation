...
eleventyNavigation:
  ...
  parent: Incoming E-mails
  order: 4
---

[Sieve](http://sieve.info/) is a language for filtering e-mails. It is used to add complex rules that cannot be added via the [filtering rules](/en/docs/e-mails/incoming-e-mails/add-a-filter-rule).
