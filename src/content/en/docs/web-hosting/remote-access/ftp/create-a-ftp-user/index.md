...
![Administration interface: list of FTP use](images/admin-panel_list-ftp-users.png)
...
![Administration interface: add FTP use](images/admin-panel_add-ftp-user.png)
