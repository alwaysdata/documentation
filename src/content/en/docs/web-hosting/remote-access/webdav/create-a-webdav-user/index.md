...
![Administration interface: list of WebDAV users](images/admin-panel_list-webdav-users.png)
...
![Administration interface: add WebDAV use](images/admin-panel_add-webdav-user.png)
