...
- _http_: access to your [websites](/en/docs/web-hosting/sites),
- _sites_: launches, shutdowns and failures of "upstream" web servers,
- _jobs_: achievements of your [scheduled tasks](/en/docs/web-hosting/tasks),
- _services_: achievements of your [services](/en/docs/web-hosting/services),
