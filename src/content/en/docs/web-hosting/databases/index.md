...
- [MariaDB/MySQL](/en/docs/web-hosting/databases/mariadb)
- [PostgreSQL](/en/docs/web-hosting/databases/postgresql)
- [RabbitMQ](/en/docs/web-hosting/databases/rabbitmq)

On Private Cloud plans:

- [ElasticSearch](/en/docs/web-hosting/databases/elasticsearch)
...
- [Duplicate a database](/en/docs/web-hosting/databases/duplicate-database)
