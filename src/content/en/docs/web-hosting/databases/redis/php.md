...
Using Redis in PHP requires [installing a PECL extension](/en/docs/web-hosting/languages/php/extensions#from-peclhttpspeclphpnet) in your account through [SSH](/en/docs/web-hosting/remote-access/ssh).
