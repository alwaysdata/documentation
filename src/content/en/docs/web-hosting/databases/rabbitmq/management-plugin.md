...
Create a site of the type [Reverse proxy](/en/docs/web-hosting/sites/add-a-site#configuration) pointing on `https://localhost:15672`. In its vhost directives, add:
