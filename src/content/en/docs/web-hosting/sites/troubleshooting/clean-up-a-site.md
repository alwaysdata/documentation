---
title: Removing a Website Infection
eleventyNavigation:
  key: Removing a Website Infection
  parent: Websites - Troubleshooting
  order: 2
---
...
The following commands, presented for a site that uses PHP, are run via [SSH](/en/docs/web-hosting/remote-access/ssh) in your site's directory.
...
> [!TIP]
> If the infection is a **recent** one and the search for the infection a complex one, then it is possible to work from a [backup](/en/docs/web-hosting/backups).
...
- Implement the [web application firewall](/en/docs/web-hosting/sites/customizing/waf),
