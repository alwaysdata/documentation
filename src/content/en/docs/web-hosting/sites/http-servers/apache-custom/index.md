...
> [!WARNING]
> If you only wish to add global directives to Apache, change its [configuration](/en/docs/web-hosting/sites/http-servers/configure-apache) in **Web > Configuration > Apache**.
