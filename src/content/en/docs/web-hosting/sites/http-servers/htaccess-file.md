...
This function is available directly by declaring a [Redirect](/en/docs/web-hosting/sites/http-servers/redirect) site type, but you can do this using the `.htaccess` file:
