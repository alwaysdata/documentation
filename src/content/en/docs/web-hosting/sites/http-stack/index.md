...
- launches the [defined](/en/docs/web-hosting/sites/add-a-site) HTTP servers and programs to serve your datas,
- returns the right [SSL certificate](/en/docs/web-hosting/sites/ssl-tls/certificates-priorities),
- logs HTTP requests. These logs are available via the [`$HOME/admin/logs` directory](/en/docs/web-hosting/remote-access/admin-directory#logs).
