...
- Enable the **[HTTP cache](/en/docs/web-hosting/sites/customizing/http-cache)** on your administration interface and/or at the application level using [Memcached](/en/docs/development/guides/memcached), [Redis](/en/docs/development/guides/redis) or any other software cache,
- Change to the latest possible language versions - to improve performance,
- Set a redirect to a **[static page](/en/docs/web-hosting/sites/http-servers/static-files)** - using far less resources, these can be sent faster.
