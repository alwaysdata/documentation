...
![Caching a resource when it is requested](images/http-cache_part-1.png)
...
![Returning a resource cached previously](images/http-cache_part-2.png)
...
> [!NOTE]
> While the HTTP cache is appropriate in most cases, you can also [run Varnish](/en/docs/web-hosting/sites/http-servers/user-program) on your alwaysdata account.
