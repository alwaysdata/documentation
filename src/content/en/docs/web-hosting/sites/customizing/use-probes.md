...
eleventyNavigation:
  key: Monitoring Probes
  parent: Customizing
  order: 30
---

For our users who have a [Dedicated/Gold server](/en/docs/admin-billing/billing/private-cloud-prices), it is possible to program monitoring probes to check that a website is working properly. If a problem is observed by a probe, an alert is sent to our team.
