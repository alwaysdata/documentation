...
2. Activate the [HTTP cache](/en/docs/web-hosting/sites/customizing/http-cache) on the website in **Web > Sites > Modify the [site] - ⚙️ > Cache**.
