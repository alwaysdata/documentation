...
A backup of your files, databases and emails is made **daily** and is available from the `/home/[account]/admin/backup` directory in your account. These backups are retained for a *rolling* number of days, depending on the chosen plan:
...
You can restore [a website](/en/docs/web-hosting/backups/restore-a-site) or [emails](/en/docs/web-hosting/backups/restore-emails) from the **Advanced > Restore backups** tab in your administration interface.
