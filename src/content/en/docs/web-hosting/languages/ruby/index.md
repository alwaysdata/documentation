...
- the [provisioned versions](/en/docs/web-hosting/languages/ruby/configuration#supported-versions) range from 1.8 to 4.0,
- the [environment configuration](/en/docs/web-hosting/languages/ruby/configuration#environment) is easy to set up.
