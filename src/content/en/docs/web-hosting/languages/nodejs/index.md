...
- the [provisioned versions](/en/docs/web-hosting/languages/nodejs/configuration/#supported-versions) range from 6 to 24,
- the [environment configuration](/en/docs/web-hosting/languages/nodejs/configuration/#environment) is easy to set up.
