...
- Rust is a compiled language that does not need an interpreter to run the programs but [version](/en/docs/web-hosting/languages/rust/configuration#version) 1.78 is available.
- Its [HTTP deployment](/en/docs/web-hosting/languages/rust/configuration#deployment-http) is simple.
