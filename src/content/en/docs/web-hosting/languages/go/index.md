...
- Go is a compiled language that does not need an interpreter to run the programs but [version](/en/docs/web-hosting/languages/go/configuration/#version) 1.26 is available.
