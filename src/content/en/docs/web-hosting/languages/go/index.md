...
- Go is a compiled language that does not need an interpreter to run the programs but [version](/en/docs/web-hosting/languages/go/configuration/#version) 1.22 is available.
- Its [HTTP deployment](/en/docs/web-hosting/languages/go/configuration/#deployment-http) is simple.
