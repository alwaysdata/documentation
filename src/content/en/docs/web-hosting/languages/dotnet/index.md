...
- the [provisioned versions](/en/docs/web-hosting/languages/dotnet/configuration#supported-versions) 5.0, 6.0, 8.0 and 10.0 are available,
- the [environment configuration](/en/docs/web-hosting/languages/dotnet/configuration#environment) is easy to set up.
