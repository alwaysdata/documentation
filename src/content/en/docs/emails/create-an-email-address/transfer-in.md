---
title: Migrating Email Addresses to alwaysdata
eleventyNavigation:
  key: Transferring your Emails
  parent: Creating a Mailbox
  order: 1
---

Here is how to move emails addresses to alwaysdata.


1. [Create email addresses](/en/docs/emails/create-an-email-address) in your admin interface, **Emails > Addresses** menu,

2. Migrate emails already existing with the current provider via **Emails > Addresses > Modify [example@example.org] -  ⚙️ > Import emails**.
...
This migration can be paired with a [website migration](/en/docs/web-hosting/sites/transfer-in) or a [domain transfer](/en/docs/domains/transfer-a-domain).
