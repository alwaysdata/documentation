...
> [Private Cloud](/en/docs/admin-billing/billing/private-cloud-prices) users can ask us to install *Redis* [at server level](/en/docs/web-hosting/databases/redis/).
