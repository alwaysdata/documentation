...
To avoid the need to suddenly migrate your server and therefore all of the accounts located there, [migrations take place in a number of steps](/en/docs/technical-specifications/migrations/private-cloud-migrations/required-migrations-process).
