...
- **[WebDAV](/en/docs/web-hosting/remote-access/webdav)** (*Remote access > WebDAV* menu),
- **[Environment](/en/docs/web-hosting/languages)**: configure the programming languages (*Environment* menu),
- **Processes**: processes currently executed that may be analyzed or killed (*Advanced > Processes* menu),
- **[IP addresses](/en/docs/web-hosting/dedicated-ip-addresses)**: rent dedicated IPs for HTTP or SMTP (*Advanced > IP addresses* menu),
- **[SSL certificates](/en/docs/web-hosting/sites/ssl-tls)** (*Advanced > SSL certificates* menu),
- **[Migration](/en/docs/technical-specifications/migrations)** (*Advanced > Migrations* menu),
- **[Scheduled tasks](/en/docs/web-hosting/tasks)** (*Advanced > Scheduled tasks* menu),
- **[Backups](/en/docs/web-hosting/backups)** (*Advanced > Backup recovery* menu),
- **[Services](/en/docs/web-hosting/services)** (*Advanced > Services* menu).
...
- **[Resources](/en/docs/technical-specifications/system-resources-alerts-and-limitations)**: change the resource limits by account - RAM, CPU, disk space (*Resources* menu),
- **[Migration](/en/docs/technical-specifications/migrations)** (*Migrations* menu) ;

## 2FA required

When the **2FA required** box is checked, the user in question must log in [with 2 factors](/en/docs/admin-billing/profile/two-factor-authentication) to access the menus to which they have been given access.
