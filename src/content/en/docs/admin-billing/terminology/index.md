...
On these **accounts**, it is possible to manage [domains](/en/docs/domains/), host [email addresses](/en/docs/emails/), [websites](/en/docs/web-hosting/sites), [databases](/en/docs/web-hosting/databases), or other applications.
