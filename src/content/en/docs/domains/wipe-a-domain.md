...
To easily relinquish a domain name, **simply do not renew it**. When a domain is not renewed, it is automatically deleted from the register after [various phases](/en/docs/domains/deadlines) (depending on the extension involved).
