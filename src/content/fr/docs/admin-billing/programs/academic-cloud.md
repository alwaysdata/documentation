---
permalink: /fr/docs/admin-facturation/programmes/academic-cloud/
title: Alwaysdata Academic Cloud
eleventyNavigation:
  key: Alwaysdata Academic Cloud
  parent: Programmes
---
...
> [!NOTE]
> Lors de la procédure d'inscription, les étudiants peuvent choisir entre plusieurs packs. Pour bénéficier du Academic Cloud gratuit, ils doivent choisir le pack *Free*.


Une fois la formation finie, les étudiants pourront conserver leurs comptes, supprimer les [permissions](/fr/docs/admin-facturation/permissions) accordées au formateur, et éventuellement [changer d'offre](/fr/docs/admin-facturation/facturation/changer-doffre/).
