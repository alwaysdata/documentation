---
permalink: /fr/docs/admin-facturation/ticket-urgent/
title: Ticket urgent
eleventyNavigation:
  key: Ticket urgent
...
- les modifications effectuées depuis l'interface d'administration alwaysdata ne sont pas correctement prises en compte.
