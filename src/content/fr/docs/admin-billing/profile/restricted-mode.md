---
permalink: /fr/docs/admin-facturation/profil/mode-restreint/
title: Lever le mode restreint
eleventyNavigation:
  key: Lever le mode restreint
...
- avoir renseigné une *carte bancaire* dans vos moyens de paiement (même en ayant un compte gratuit) ;
...
Si en revanche, aucune *carte bancaire* n'est configurée dans votre compte, et que vous n'avez encore jamais réglé quoi que ce soit, les comptes que vous posséderez sur alwaysdata seront restreints techniquement.
