---
permalink: /fr/docs/hebergement-web/langages/python/
title: Python
eleventyNavigation:
  key: Python
  parent: Langages
...
* les [versions proposées](/fr/docs/hebergement-web/langages/python/configuration#versions-supportées) vont de la 2.4 à la 3.14 ;
* la [configuration d'environnement](/fr/docs/hebergement-web/langages/python/configuration#environnement) se fait très simplement.
