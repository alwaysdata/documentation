---
permalink: /fr/docs/hebergement-web/langages/nodejs/
title: Node.js
eleventyNavigation:
  key: Node.js
  parent: Langages
...
* les [versions proposées](/fr/docs/hebergement-web/langages/nodejs/configuration#versions-supportées) vont de la 6 à la 24 ;
* la [configuration d'environnement](/fr/docs/hebergement-web/langages/nodejs/configuration#environnement) se fait très simplement.
