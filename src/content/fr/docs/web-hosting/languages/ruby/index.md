---
permalink: /fr/docs/hebergement-web/langages/ruby/
title: Ruby
eleventyNavigation:
  key: Ruby
  parent: Langages
...
* les [versions proposées](/fr/docs/hebergement-web/langages/ruby/configuration/#versions-supportées) vont de la 1.8 à la 4.0 ;
* la [configuration d'environnement](/fr/docs/hebergement-web/langages/ruby/configuration/#environnement) se fait très simplement.
