---
permalink: /fr/docs/hebergement-web/langages/lua/
title: Lua
eleventyNavigation:
  key: Lua
  parent: Langages
...
* les [versions proposées](/fr/docs/hebergement-web/langages/lua/configuration/#versions-supportées) vont de la 5.1 à la 5.4 ;
* la [configuration d'environnement](/fr/docs/hebergement-web/langages/lua/configuration/#environnement) se fait simplement.
