---
permalink: /fr/docs/hebergement-web/bases-de-donnees/postgresql/
title: PostgreSQL
eleventyNavigation:
  key: PostgreSQL
...
En Cloud Public, le nombre de connexions simultanées maximum par utilisateur est de _50_. Il est possible à la demande de le modifier en [Cloud Privé](/fr/docs/admin-facturation/facturation/prix-cloud-prive/).
