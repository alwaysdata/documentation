---
permalink: /fr/docs/hebergement-web/services/
title: Services
eleventyNavigation:
  key: Services
...
Pour les utilisateurs du [Cloud Privé](/fr/docs/admin-facturation/facturation/prix-cloud-prive/) :

- Les ports `8300` à `8499` ne sont *pas* ouverts vers l'extérieur. Il est possible de les ouvrir via une [règle de parefeu](/fr/docs/caracteristiques-techniques/configurer-le-firewall) ;
