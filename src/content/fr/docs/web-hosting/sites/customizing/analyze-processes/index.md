---
permalink: /fr/docs/hebergement-web/sites/personnalisation/analyser-des-processus/
title: Analyser des processus HTTP
eleventyNavigation:
  key: Analyser des processus HTTP
...
L'analyse des processus produit un fichier, disponible à la racine de votre compte (nommé `analysis_[date]-[heure].log` et consultable en [SSH](/fr/docs/hebergement-web/acces-distant/ssh/) ou [FTP](/fr/docs/hebergement-web/acces-distant/ftp/)) décrivant les opérations exécutées par le processus pendant une durée déterminée.

## 1. Démarrer l'analyse

La fonctionnalité d'analyse de processus est disponible via **Avancé > Processus > Analyser les processus**.
![Menu Processus : liste](images/admin-panel_processes-list.png)
![Analyser des processus](images/admin-panel_processes-analysis.png)
