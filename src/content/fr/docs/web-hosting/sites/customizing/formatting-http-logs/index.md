---
permalink: /fr/docs/hebergement-web/sites/personnalisation/formater-les-logs-http/
title: Formater les logs HTTP
eleventyNavigation:
  key: Formater les logs HTTP
...
![](images/admin-panel_add-site-logs_custom.png)
...
[^3]: Un seul header peut être spécifié. Exemples : `{request_header:authorization}`, `{response_header:age}` (à utiliser avec le [cache HTTP](/fr/docs/hebergement-web/sites/personnalisation/cache-http/))
