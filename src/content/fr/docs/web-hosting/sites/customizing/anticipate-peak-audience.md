---
permalink: /fr/docs/hebergement-web/sites/personnalisation/anticiper-un-pic-daudience/
title: Anticiper un pic d'audience
eleventyNavigation:
  key: Anticiper un pic d'audience
...
- activer le **[cache HTTP](/fr/docs/hebergement-web/sites/personnalisation/cache-http/)** sur votre interface d'administration et/ou au niveau applicatif en utilisant [Memcached](/fr/docs/developpement/guides/memcached/), [Redis](/fr/docs/developpement/guides/redis/) ou tout autre cache logiciel ;
- passer sur les versions de langages les plus récentes possibles  - pour améliorer les performances ;
- faire une redirection vers une **[page statique](/fr/docs/hebergement-web/sites/serveurs-http/fichiers-statiques/)** - utilisant bien moins de ressources, elles sont plus rapides à renvoyer.
