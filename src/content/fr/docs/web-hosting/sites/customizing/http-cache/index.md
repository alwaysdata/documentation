---
permalink: /fr/docs/hebergement-web/sites/personnalisation/cache-http/
title: Cache HTTP
eleventyNavigation:
  key: Cache HTTP
...
![Mise en cache d’une res­source lors de sa requête](images/http-cache_part-1.png)
...
![Restitution d’une res­source pré­cé­dement mise en cache](images/http-cache_part-2.png)
...
![](images/admin-panel_add-site-cache.png)
...
> [!NOTE]
> Bien que le cache HTTP convienne dans l'immense majorité des cas, vous pouvez également [faire tourner Varnish](/fr/docs/hebergement-web/sites/serveurs-http/programme-utilisateur/) sur votre compte alwaysdata.
