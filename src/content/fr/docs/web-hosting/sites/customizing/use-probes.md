---
permalink: /fr/docs/hebergement-web/sites/personnalisation/utiliser-les-sondes-de-monitoring/
title: Utiliser les sondes de monitoring
eleventyNavigation:
  key: Sondes de monitoring
  parent: Personnalisation
  order: 30
---

Pour nos utilisateurs qui disposent d'un [serveur Dédié/Gold](/fr/docs/admin-facturation/facturation/prix-cloud-prive/), il est possible de programmer des sondes de monitoring afin de vérifier qu'un site web fonctionne correctement. Si un problème est constaté par une sonde, une alerte est envoyée à notre équipe.
