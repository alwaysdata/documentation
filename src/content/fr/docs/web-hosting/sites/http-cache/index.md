---
permalink: /fr/docs/hebergement-web/sites/cache-http/
title: Cache HTTP
eleventyNavigation:
  key: Cache HTTP
  parent: Sites web
...
> [!NOTE]
> Bien que le cache HTTP convienne dans l'immense majorité des cas, vous pouvez également [faire tourner Varnish](/fr/docs/hebergement-web/sites/programme-utilisateur/) sur votre compte alwaysdata.
