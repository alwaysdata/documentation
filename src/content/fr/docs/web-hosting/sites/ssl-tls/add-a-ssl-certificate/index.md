...
Si vous n'avez pas de certificat SSL, vous pouvez utiliser nos [certificats Let's Encrypt](/fr/docs/hebergement-web/sites/ssl-tls/certificats-lets-encrypt/) ou en acheter un chez un fournisseur de certificats SSL en lui donnant la [CSR précédemment créée](/fr/docs/hebergement-web/sites/ssl-tls/csr).
