---
permalink: /fr/docs/hebergement-web/sites/problemes-frequents/
title: Problèmes fréquents
eleventyNavigation:
  key: Sites - Problèmes fréquents
  parent: Sites web
  order: 99
---

- [Désinfecter un site web](/fr/docs/hebergement-web/sites/problemes-frequents/desinfecter-un-site)
- [PHP](/fr/docs/hebergement-web/langages/php/problemes-frequents/)

## Connexion

Services externes permettant de vérifier la disponibilité d'un site : [Where's It Up?](https://wheresitup.com/), [Screenshot Guru](https://screenshot.guru/) (avec capture d'écran).

- [Connection to upstream refused, Connection to upstream skipped, Upstream not ready, Cannot parse upstream response](/fr/docs/hebergement-web/sites/problemes-frequents/erreurs-connection-to-upstream/)
...
Pour les sites utilisant [Apache](/fr/docs/hebergement-web/sites/serveurs-http/configurer-apache/), il va par défaut rechercher pour la page d'accueil un fichier nommé `index.html` ou `index.php`. Renommez votre fichier ou utilisez la directive [DirectoryIndex](https://httpd.apache.org/docs/2.4/fr/mod/mod_dir.html#directoryindex) dans un `.htaccess`.
