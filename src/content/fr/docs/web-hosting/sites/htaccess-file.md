---
permalink: /fr/docs/hebergement-web/sites/fichier-htaccess/
...
Cette fonctionnalité est disponible directement en déclarant un site de type [Redirection](/fr/docs/hebergement-web/sites/redirection/), mais vous pouvez le faire grâce au fichier `.htaccess` :
