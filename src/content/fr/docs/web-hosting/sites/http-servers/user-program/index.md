---
permalink: /fr/docs/hebergement-web/sites/serveurs-http/programme-utilisateur/
...
![](images/admin-panel_user-program.png)
...
Si le programme ne se lance pas, les logs _sites_ disponibles dans le répertoire `/home/[compte]/admin/logs/sites/` pourront vous aider.
