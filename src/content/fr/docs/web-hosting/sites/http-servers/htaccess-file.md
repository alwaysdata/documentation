---
permalink: /fr/docs/hebergement-web/sites/serveurs-http/fichier-htaccess/
title: Fichier .htaccess
eleventyNavigation:
  key: Fichier .htaccess
...
Cette fonctionnalité est disponible directement en déclarant un site de type [Redirection](/fr/docs/hebergement-web/sites/serveurs-http/redirection/), mais vous pouvez le faire grâce au fichier `.htaccess` :
