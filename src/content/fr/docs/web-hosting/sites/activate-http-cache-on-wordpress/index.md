---
permalink: /fr/docs/hebergement-web/sites/activer-le-cache-http-sur-wordpress/
...
2. Activez le [cache HTTP](/fr/docs/hebergement-web/sites/cache-http/) sur le site web dans **Web > Sites > Modifier le [site] - ⚙️ > Cache**.
