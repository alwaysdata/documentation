---
permalink: /fr/docs/hebergement-web/sites/formater-les-logs-http/
...
[^3]: Un seul header peut être spécifié. Exemples : `{request_header:authorization}`, `{response_header:age}` (à utiliser avec le [cache HTTP](/fr/docs/hebergement-web/sites/cache-http/))
