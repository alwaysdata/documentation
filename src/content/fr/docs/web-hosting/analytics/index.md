---
permalink: /fr/docs/hebergement-web/statistiques/
title: Statistiques
eleventyNavigation:
  key: Statistiques
...
Un graphe au niveau serveur est disponible dans le menu **HTTP > Analytics** pour le [Cloud Privé](/fr/docs/admin-facturation/facturation/prix-cloud-prive/).
