...
Notre plateforme s’appuie sur [Debian](https://www.debian.org/) et sa [crontab](https://fr.wikipedia.org/wiki/Cron) mais permet de les gérer directement dans l'interface d'administration - onglet **Avancé > Tâches planifiées** - et d'en faciliter l'utilisation.
