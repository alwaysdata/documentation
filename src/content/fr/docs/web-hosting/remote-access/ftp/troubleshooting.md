...
Un [blocage d'IP](/fr/docs/caracteristiques-techniques/reseau/) a lieu après une dizaine de tentatives échouées de connexion au serveur.
...
Si aucune de ces solutions ne fonctionne, essayez la connexion [SFTP](/fr/docs/hebergement-web/acces-distant/sftp/).
...
Si vous ne pouvez corriger ce comportement, vous pouvez essayez la connexion [SFTP](/fr/docs/hebergement-web/acces-distant/sftp/).
