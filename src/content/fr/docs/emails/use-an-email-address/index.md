---
permalink: /fr/docs/emails/utiliser-une-adresse-email/
...
- Les emails sont conservés au format [Maildir](https://fr.wikipedia.org/wiki/Maildir) dans le répertoire `/home/[compte]/admin/mail` ;
