---
permalink: /fr/docs/caracteristiques-techniques/mises-a-jour-de-securite/
title: Mises à jour de sécurité
eleventyNavigation:
  key: Mise à jour de sécurité
...
La mise à jour principale de nos systèmes d'exploitation s'effectue via un [outil d'automatisation](/fr/docs/caracteristiques-techniques/migrations) permettant de le faire de façon autonome et flexible par compte.
