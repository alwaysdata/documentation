...
* En [Cloud public](/fr/docs/admin-facturation/facturation/prix-cloud-public/), votre compte sera déplacé sur de nouveaux serveurs lors de la migration, et tous les services vont donc changer d'IP. Les IP utilisées par chaque serveur sont données dans le menu **Avancé > Statut des serveurs**.
