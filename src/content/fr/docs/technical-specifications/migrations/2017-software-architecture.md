...
* Les extensions non standard (APC, Xapian, Xdebug et Mapscript pour PHP 5.3 et 5.2 et Fileinfo en 5.2) sont supprimées. Vous pourrez toutefois les [installer vous-même](/fr/docs/hebergement-web/langages/php/installer-une-extension/) dans votre propre compte.

* Symfony n'est plus préinstallé, vous devrez [manuellement l'installer](/fr/docs/hebergement-web/langages/php/installer-un-paquet/).
...
* Les quelques bibliothèques auparavant préinstallées par défaut sont supprimées, y compris Django. Vous devez donc [manuellement installer](/fr/docs/hebergement-web/langages/python/configuration/#environnement) toutes les bibliothèques dont vous aurez besoin.
...
* Les quelques bibliothèques auparavant préinstallées par défaut sont supprimées, y compris Ruby on Rails. Vous devez donc [manuellement installer](/fr/docs/hebergement-web/langages/ruby/configuration/#environnement) toutes les bibliothèques dont vous aurez besoin.
