---
permalink: /fr/docs/caracteristiques-techniques/bug-bounty/
title: Bug Bounty
eleventyNavigation:
  key: Bug Bounty
...
* le nom des comptes est [accessible de nombreuses façons différentes](/web-hosting/remote-access/misc#lister-les-comptes) ;
...
* Le répertoire `/tmp` est un [répertoire partagé](/web-hosting/remote-access/misc#répertoire-tmp) ;
...
* le numéro de version des logiciels que nous utilisons [ne peut être déterminant](/fr/docs/caracteristiques-techniques/mises-a-jour-de-securite).
