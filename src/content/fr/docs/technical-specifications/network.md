---
permalink: /fr/docs/caracteristiques-techniques/reseau/
title: Réseau
eleventyNavigation:
  key: Réseau
...
Les utilisateurs propriétaires de [Cloud Privés](/admin-billing/billing/private-cloud-prices) peuvent [paramétrer leur firewall](/fr/docs/caracteristiques-techniques/configurer-le-firewall) directement dans leur interface d'administration, via le menu **Firewall** du serveur.
