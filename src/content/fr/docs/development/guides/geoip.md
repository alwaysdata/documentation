---
permalink: /fr/docs/developpement/guides/geoip/
title: Bloquer des visites via GeoIP
eleventyNavigation:
  key: Bloquer des visites via GeoIP
  parent: Guides
  order: 1
---

[MaxMind DB](https://www.maxmind.com/en/geoip2-services-and-databases)[^1] est un module [Apache](/fr/docs/hebergement-web/sites/serveurs-http/configurer-apache/) de GeoIP qui vise à localiser un utilisateur en se basant sur son adresse IP.
...
> [!NOTE]
> Prendre la [dernière version disponible de `mod_maxminddb`](https://github.com/maxmind/mod_maxminddb). N'hésitez pas à ajuster en fonction de vos besoins.
...
```
MaxMindDBEnable On
MaxMindDBFile COUNTRY_DB /home/[compte]/GeoLite2-Country.mmdb
