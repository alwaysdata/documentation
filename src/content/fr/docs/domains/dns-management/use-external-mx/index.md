---
permalink: /fr/docs/domaines/gestion-dns/utiliser-des-mx-externes/
...
- créez [l'adresse email](/fr/docs/emails/creer-une-adresse-email/) sur l'interface d'administration ;
- envoyez un email à :
