---
permalink: /fr/docs/domaines/detruire-un-domaine/
title: Détruire un domaine
eleventyNavigation:
  key: Détruire un domaine
  parent: Domaines
  order: 11
---
...
Pour se séparer de son nom de domaine sans difficulté, **il suffit de ne pas le renouveler**. Lorsqu’un domaine n’est pas renouvelé, il est automatiquement détruit au registre après [différentes phases](/fr/docs/domaines/renouveler-un-domaine/dates-limites/) (différentes selon l’extension concernée).
