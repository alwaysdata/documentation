---
permalink: /fr/docs/emails/brevo/
...
Brevo (anciennement Sendinblue) est une plateforme d'emailing connue. Pour améliorer la délivrabilité des emails envoyés, il faut les [authentifier](/fr/docs/emails/configurer-spf-dkim-dmarc/) en créant, chez votre prestataire, des enregistrements DNS qu'ils vous donneront. Voici comment le faire chez alwaysdata.
