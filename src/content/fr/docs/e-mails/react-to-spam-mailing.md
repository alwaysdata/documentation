---
permalink: /fr/docs/emails/reagir-envoi-spam/
...
- [une infection de site internet](/fr/docs/hebergement-web/sites/desinfecter-un-site/) ;
...
Le [WAF](/fr/docs/hebergement-web/sites/waf/) peut être utile pour bloquer certaines attaques.
