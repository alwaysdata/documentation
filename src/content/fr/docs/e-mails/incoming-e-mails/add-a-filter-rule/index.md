---
permalink: /fr/docs/emails/emails-entrants/ajouter-regle-filtrage/
...
> [!TIP] Astuce
> Pour créer des règles plus compliquées, ce sera des [règles Sieve](/fr/docs/emails/emails-entrants/utiliser-les-scripts-sieve/).
