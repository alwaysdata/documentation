---
permalink: /fr/docs/emails/emails-sortants/reagir-envoi-spam/
title: Réagir à un envoi de spam
eleventyNavigation:
  key: Réagir à un envoi de spam
...
- [une infection de site internet](/fr/docs/hebergement-web/sites/problemes-frequents/desinfecter-un-site/) ;
...
Le [WAF](/fr/docs/hebergement-web/sites/personnalisation/waf/) peut être utile pour bloquer certaines attaques.
