---
permalink: /fr/docs/emails/emails-sortants/delivrabilite-bonnes-pratiques/
title: Comment améliorer la délivrabilité d'emails
eleventyNavigation:
  key: "Délivrabilité : bonnes pratiques"
  parent: Emails sortants
  order: 1
---
...
- Utilisez les [protocoles d'identification](/fr/docs/emails/emails-sortants/configurer-spf-dkim-dmarc/) ;
...
Plus la note est basse mieux l'email sera noté et l'envoi accepté. Sur le Cloud Public, tout email ayant une note supérieure à _3_ sera bloqué. En [Cloud Privé](/fr/docs/admin-facturation/facturation/prix-cloud-prive/), la valeur par défaut est de _5_ et vous pouvez la modifier dans l'onglet **SMTP > Paramètres** de votre serveur. Il n'est pas possible de le désactiver.
