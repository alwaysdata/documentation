...
Vous pouvez [créer une adresse email](/fr/docs/emails/creer-une-adresse-email/) dans l'onglet **Emails > Adresses** de l'interface d'administration et [consulter vos emails](/fr/docs/emails/utiliser-une-adresse-email/) via un client mail de votre choix ou notre [webmail](https://webmail.alwaysdata.com).
