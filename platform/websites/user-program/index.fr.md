+++
url = "/fr/plateforme/sites/programme-utilisateur/"
...
{{% notice tip %}}
Avant de mettre en place le site, vous pouvez tester le lancement du programme en [SSH]({{< ref "platform/remote-access/ssh" >}}).
{{% /notice %}}
