+++
url = "/fr/plateforme/sites/fichier-htaccess/"
...
Cette fonctionnalité est disponible directement en déclarant un site de type [Redirection]({{< ref "platform/websites/redirect" >}}), mais vous pouvez le faire grâce au fichier `.htaccess` :
