...
* les [versions proposées]({{< ref "languages/ruby/configuration" >}}#versions-supportées) vont de la 1.8 à la 2.6 ([v2017]({{< ref "accounts/version" >}})) et 2.7 ([v2020]({{< ref "accounts/version" >}})) ;
