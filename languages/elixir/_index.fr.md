...
* les [versions proposées]({{< ref "languages/elixir/configuration" >}}#versions-supportées) vont de la 1.5 à la 1.7([v2017]({{< ref "accounts/version" >}})) et de la 1.6 à la 1.10 ([v2020]({{< ref "accounts/version" >}})) ;
