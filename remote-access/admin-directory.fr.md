...
- _mail_ : montage [NFS](https://fr.wikipedia.org/wiki/Network_File_System) (en serveurs mutualisés) ou un lien symbolique (en serveurs VPS et dédiés) des [emails]({{< ref "e-mails" >}}) ;
- _config_ ;
- _logs_ ;
